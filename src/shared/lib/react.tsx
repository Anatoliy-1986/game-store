...
// контексты без дефолтного значения
...
//  не показывать лоадер если меньше 5 сек и если больше то показывать подольше
...
//  красивое отображение большого количества контекстов, вместо елочки писать можно последовательно
...
//  без зависимостей вызывать функцию, меньше не нужных юзколбэков
